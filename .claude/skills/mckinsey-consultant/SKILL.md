...
description: McKinsey顾问式问题解决系统。从商业问题出发,通过假设驱动的结构化分析方法,生成McKinsey风格研究报告和PPT。融合Problem Solving方法论、MECE原则、Issue Tree拆解、Hypotheses形成、Dummy Page设计、智能数据收集和专业PPT生成能力。适用场景：(1) 业务战略评估与决策 (2) 运营问题诊断与改进 (3) 变革管理规划 (4) 投资/并购分析报告 (5) 高管汇报材料制作。当用户提到"麦肯锡"、"战略分析"、"商业报告"、"issue tree"、"MECE"、"结构化分析"、"顾问报告"时触发。
license: MIT
metadata:
  author: Qianru Tian
